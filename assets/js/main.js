(function() {
  ...
  document.getElementById('submitButton').addEventListener('click', () => {
    ...
    const average = (feature1 + feature2 + feature3 + feature4 + feature5) / 5;
    ...
    outputDiv.innerHTML = `
        ...
        <p>Emailas: ${email}</p>
        <p>Telefonas: ${phone}</p>
        <p>Gyvenamoji vieta: ${address}</p>
        <p>8 laboratorinio pažymys: ${feature1}</p>
        <p>9 laboratorinio pažymys: ${feature2}</p>
        <p>10 laboratorinio pažymys: ${feature3}</p>
        <p>11 laboratorinio pažymys: ${feature4}</p>
        <p>12 laboratorinio pažymys: ${feature5}</p>
        <p class="average" style="color: ${average < 3 ? 'red' : average < 7 ? 'orange' : 'green'};">
            ${firstName} ${lastName} (${email}): ${average.toFixed(2)}
        </p>
    `;
});
